...
export default function Navbar() {
  ...
  return (
    <header className="select-none h-[72px]">
      <nav className="mx-auto justify-between px-4 md:flex md:items-center md:px-8 lg:max-w-7xl">
        ...
        <div>
          <div
            className={`absolute left-0 right-0 z-10 m-auto w-full justify-self-center rounded-md border-t-[1px] border-gray-500  p-4 md:static md:mt-0 md:block md:border-none md:p-0 transition-all dark:bg-gray-900 bg-white md:bg-transparent ${
              navbar ? "block" : "hidden"
            }`}
          >
                ...
                if (link.path) {
                  return (
                    <li key={link.route}>
                      <Link
                        href={link.path}
                        target={link.route === "Courses" ? "_blank" : "_self"}
